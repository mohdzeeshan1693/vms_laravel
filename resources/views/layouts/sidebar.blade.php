<div id="left-sidebar" class="sidebar ">
    ...
    <nav id="left-sidebar-nav" class="sidebar-nav">
        <ul class="metismenu">
            <li class="g_heading">VMS System</li>
            <li class=""><a href=""><i class="icon-speedometer"></i><span>Dashboard</span></a></li>
            
            <li class="">
                <a href="javascript:void(0)" class="has-arrow arrow-c"><i class="fe fe-truck"></i><span>Vehicles</span></a> 
                <ul>
                    <li class=""><a href="">Information</a></li>
                    <li class=""><a href="">Joborder</a></li>
                </ul>
            </li>
        </ul>
    </nav>        
