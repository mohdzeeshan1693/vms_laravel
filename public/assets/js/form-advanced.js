$(function() {
    ...
    //Date Time
    $demoMaskedInput.find('.datetime').inputmask('d/m/y h:s:s', { placeholder: '__/__/____ __:__:__', alias: "datetime", hourFormat: '24' });

    //Date
    $demoMaskedInput.find('.dateonly').inputmask('d/m/y', { placeholder: '__/__/____' });
